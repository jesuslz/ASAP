...
instanca_Data.write_pandas_xlsx_document(instanca_Data.dictionary_to_pyMatrix(dictionary_timeout), 'timeout-WASS.xlsx')
instanca_Data.write_pandas_xlsx_document(instanca_Data.dictionary_to_pyMatrix(dictionary_failed), 'failed-WASS.xlsx')
...
instanca_Data.write_pandas_xlsx_document(full_Matrix, 'Performance-WASS.xlsx')
'''
